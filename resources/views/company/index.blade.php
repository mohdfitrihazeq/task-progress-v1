                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" company="group" aria-label="Basic example">
                                <a href="{{ route('company.show', $rs->company_id) }}" type="button" class="btn btn-secondary">Detail</a>
                                <a href="{{ route('company.edit', $rs->company_id)}}" type="button" class="btn btn-warning">Edit</a>
                                <form action="{{ route('company.destroy', $rs->company_id) }}" method="POST" type="button" class="btn btn-danger p-0" onsubmit="return confirm('Are you sure to Delete?')">
                                    @csrf
                                    @method('DELETE')
